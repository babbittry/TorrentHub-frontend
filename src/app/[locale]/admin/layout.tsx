...
import {
    faGaugeHigh, faPlusCircle, faBan, faCopy, faSlidersH, faUsers, faCog, faBullhorn, faFileAlt
...
export default function AdminLayout({ children }: AdminLayoutProps) {
    ...
    return (
        <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900">
            {/* Sidebar */}
            <aside className="w-64 bg-gray-800 text-white p-4 shadow-lg flex-shrink-0">
